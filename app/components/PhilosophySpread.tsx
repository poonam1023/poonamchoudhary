      ...
      left={
        ...
        >
          <motion.div
            ...
            style={{ padding: "1.5rem 1.25rem", marginTop: "1rem" }}
            initial={{ opacity: 0, y: 16 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.6 }}
          >
            <p style={{ fontSize: "clamp(1.15rem, 1.8vw, 1.55rem)", lineHeight: 1.3 }}>
        ...
        <BookPage side="right" chapterLabel="Chapter Two" pageNumber="5">
          ...
          >
            ...
            {principles.map((principle, index) => (
              ...
              >
                <h3 style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontSize: "clamp(1.1rem, 1.35vw, 1.45rem)", fontWeight: 550, color: "#2b251d" }}>{principle.title}</h3>
                <p>{principle.text}</p>
              </motion.div>
            ))}
          </motion.div>
