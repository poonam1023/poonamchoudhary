...
export default function ConnectLeft() {
  return (
    <div className="absolute inset-0 overflow-hidden" style={{ background: "linear-gradient(162deg, #FFFDF8 0%, #FAF7F2 42%, #F6EFE5 100%)" }}>
      ...
      <div className="absolute select-text" style={{ bottom: "24%", left: "12%", right: "12%", zIndex: 10 }}>
        <div style={{ borderTop: "0.5px solid rgba(110,90,78,0.12)", paddingTop: "14px" }}>
          <div className="flex flex-col items-center mb-3">
            <span style={{ fontFamily: "var(--font-cormorant), serif", fontStyle: "italic", fontSize: "clamp(12px, 1.7vh, 14px)", color: "#6E5A4E", opacity: 0.75, letterSpacing: "0.04em" }}>
              Write to me at
            </span>
            <DecorativeDivider variant="scroll" opacity={0.55} className="mt-1 w-20" />
          </div>
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2.5">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(110,90,78,0.5)" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" />
              </svg>
              <span style={{ fontFamily: "var(--font-cormorant), serif", fontSize: "clamp(13px, 1.8vh, 14.5px)", color: "#5A4A38", opacity: 0.9 }}>New Delhi, India</span>
            </div>
            <div className="flex items-center gap-2.5">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(110,90,78,0.5)" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
              </svg>
              <span style={{ fontFamily: "var(--font-cormorant), serif", fontSize: "clamp(13px, 1.8vh, 14.5px)", color: "#5A4A38", opacity: 0.9 }}>poonam@consciousparenting.com</span>
            </div>
            <div className="flex items-center gap-2.5">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(110,90,78,0.5)" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
              </svg>
              <span style={{ fontFamily: "var(--font-cormorant), serif", fontSize: "clamp(13px, 1.8vh, 14.5px)", color: "#5A4A38", opacity: 0.9 }}>@poonam.choudhary</span>
            </div>
          </div>
        </div>
      </div>
 
      <PressedFlower variant="wildflower" scale={0.85} opacity={0.8} position={{ bottom: "6%", right: "6%" }} style={{ zIndex: 12 }} />
      <WaxSeal variant="terracotta" scale={0.8} rotation={5} position={{ bottom: "10%", left: "8%" }} opacity={1.0} style={{ zIndex: 15, opacity: 1.0 }} />
